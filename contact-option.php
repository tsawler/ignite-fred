                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                ...
                                <li><a href="home-flexslider.html">Home - Flex slider</a></li>
                                ...
                                <li><a href="medical-home.html">Medical Template</a></li>
                                <li class="dropdown-submenu">
                                    <a tabindex="-1" href="#">Home Restaurant </a>
                                    <ul class="dropdown-menu">

                                        <li><a href="restaurant-one-page-light.html">One page Light</a></li>
                                        <li><a href="restaurant-one-page-dark.html">One page Dark</a></li>                                        
                                    </ul>
                                </li>
                                <li><a href="real-estate-home.html"> Real Estate</a></li>
                                <li class="dropdown-submenu">
                                    <a tabindex="-1" href="#">One Page </a>
                                    <ul class="dropdown-menu">
                                        <li><a href="one-page.html">One page Light</a></li>
                                        <li><a href="one-page-dark.html">One page Dark</a></li>                                        
                                    </ul>
                                </li>
                                <li class="dropdown-submenu">
                    ...
                    <div class="row margin40">
                        <div class="col-md-4 margin30">
                            <div class="contact-option-circle">
                                ...
                                <p>
                                    124, Munna wali dhani, lalchandpura, niwaru road, jhotwara, jaipur, 302012
                                </p>
                         ...
                         <div class="col-md-4 margin30">
                            <div class="contact-option-circle">
                                ...
                                <p>
                                    Support@designmylife.com<br>
                                    mylifedeign143@gmail.com
                                </p>
                            </div><!--contact option circle-->
                        </div><!--contact option detail box col-->
                    </div>
