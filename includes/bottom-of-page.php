                ...
                <div class="col-md-3 col-sm-6 margin30">
                    <div class="footer-col">
                        ...
                        <ul class="list-unstyled contact">
                            <li>
                                <p>
                                    <strong><i class="fa fa-map-marker"></i> Address:</strong> 40 Crowther Lane, Suite 100</p>
                            </li>
                            <li>
                                <p> Fredericton NB E3C 0J1</p>
                            </li>
                            <li>
                                <p>
                                    <strong><i class="fa fa-envelope"></i> Email:</strong> <a href="#">info@ignitefredericton.com</a></p>
                            </li>
                            <li>
                                <p>
                                    <strong><i class="fa fa-phone"></i> Phone:</strong> +1.506.444.4686</p>
                            </li>
                ...
                <div class="col-md-3 col-sm-6 margin30">
                    <div class="footer-col">
                        ...
                        <ul class="list-inline f2-work">
                            ...
                            <li>
                                <a href="portfolio-single.html">
                                    <img src="img/img-9.jpg" class="img-responsive" alt="">
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <form role="form" class="subscribe-form">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn  btn-theme-dark border-ignite btn-lg" type="submit">Ok</button>
                                </span>
                            </div>
                        </form>
                    </div>
