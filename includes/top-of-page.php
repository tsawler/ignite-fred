...
<head>
    ...
    <title>Ignite Fredericton</title>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown ">
                        ...
                        <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                            ...
                            <li><a href="#">Innovation &amp; Education</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu multi-level" role="menu">
                            ...
                            <li><a href="#">Partnership &amp; Matching</a></li>
                        </ul>
                    </li>
                    <!--/How We can help-->

                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Key Sectors<i class="fa fa-angle-down"></i></a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="sectors.php">All Key Sectors</a></li>
                            <li><a href="natural-resources.php">Natural Resources</a></li>
